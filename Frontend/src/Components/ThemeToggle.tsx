...
export default function ThemeToggle({ rtype }: Props) {
    ...
    useEffect(() => {
        if (!("theme" in localStorage)) {
            ...
            toggleThemeClass(prefersDarkScheme.matches ? "dark" : "light")
        } else {
        ...
        <>
            {rtype === "switch" ? (
                ...
                <Select
                    ...
                    label=""
                    onChange={(
                        e: SelectChangeEvent<"light" | "dark" | "system">
                    ) => {
                        const themeValue = e.target.value as ThemeScheme
                        setTheme(themeValue)
